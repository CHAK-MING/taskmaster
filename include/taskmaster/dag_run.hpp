...
public:
  ...
  [[nodiscard]] auto state() const noexcept -> DAGRunState { return state_; }
  [[nodiscard]] auto dag() const noexcept -> const DAG & { return dag_; }
...
private:
  ...
  DAG dag_;
  DAGRunState state_{DAGRunState::Pending};
