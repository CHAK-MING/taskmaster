...
export BUILD2_CONFIG_NAME="${BUILD2_CONFIG_NAME:-ubsan-clang}"
export BUILD2_CONFIG_ROOT="${BUILD2_CONFIG_ROOT:-${XDG_DATA_HOME:-$HOME/.local/share}/build2-configs}"
export BUILD2_CONFIG_FORWARD=0
export BUILD2_CC_COPTIONS="-fsanitize=undefined -fno-omit-frame-pointer"
export BUILD2_CC_LOPTIONS="-fsanitize=undefined"
